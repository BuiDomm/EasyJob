        ...
        <div class="container">
            <div style="display:flex;">
                <div class="login-box" style="margin-top: 200px">
                    <form class="form_container" method="get" action="updateprofilejb">
                        ...
                        <div class="input_container">
                            ...
                            <input placeholder="Password" title="Inpit title" name="password" value="${account.password}" type="password" class="input_field" id="password_field">
                        </div>
