...
<!DOCTYPE html><html class="menu">
    <html>
        ...
        <body>
            ...
            <form class="user-form container" action="editblog" method="get" enctype="multipart/form-data">

                <h5>Your blog profile</h5>
                <label class="form-label">Title</label>
                <div class="input-group mb-3">
                    <input value="${product.title}" name="title" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                    <input value="${product.blogId}" name="blogId" type="hidden" class="form-control" readonly required>

                </div>

                <div class="mt-3 mb-3">
                    <label class="form-label">Your Blog Description</label>
