                        ...
                        <div class="row">
                            <div class="card">
                                ...
                                <div class="row justify-content-end">
                                    ...
                                    <div class="col-2">
                                        <a onclick="showMess('${b.blogId}',
                                                        'adminBlogReject?blogId=', '${b.title}', '${dao.getUserByBlogId(b.blogId).getFirstName()}', 'reject')"  
                                           class="btn btn-block btn-danger btn-md">Reject Blog</a>
                                    </div>
                                    ...
                                    <div class="col-2">
                                        ...
                                        <a onclick="showMess('${b.blogId}',
                                                        'adminBlogAccept?blogId=', '${b.title}', '${dao.getUserByBlogId(b.blogId).getFirstName()}', 'accept')"  
                                           class="btn btn-block btn-success btn-md">Accept Blog</a>
                                    </div>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
        <script>
            function showMess(id, url, title, name, key) {
                if (key === "reject") {
                    var option = confirm('Are you sure you want to ' + key + ' this blog?\n' +
                            'Title: ' + title + '\n' +
                            'Account name: ' + name);
                    if (option === true) {
                        // Show the modal
                        ...
                        $('#saveBtn').click(function () {
                            ...
                            $.ajax({
                                ...
                                success: function () {
                                    ...
                                    console.log("ok");
                                    $('#rejectModal').modal('hide');
                                    window.location.href = 'adminListBlog';
