        ...
        <div class="login-box">
            <form class="form_container" method="post" action="loginjobseeker?role=3">
                ...
                <div class="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title" name="email" type="text" class="input_field" id="email_field" value="${cookie.cusere.value}">
                </div>
                <div class="input_container">
                ...
                <a href="forgetpassemployeer.jsp" class="note" style="font-weight: 600;text-decoration: none;">Reset password</a>
                <div style="display: flex;align-items: center">
                    <p class="note" style="color:#00000080;font-weight: 600; ">No account? </p><a style="text-decoration: none;font-weight: 600" href="registeremployeer.jsp"class="note">Create one</a>
