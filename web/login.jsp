<%-- 
    Document   : login
    Created on : May 15, 2024, 12:07:47 AM
    Author     : ASUS
--%>
...
<html>
    ...
    <body>
     ...
     Boolean isVerified = (Boolean) request.getAttribute("successfully");
        ...
        <div class="login-box">
            <form class="form_container" method="post" action="loginjobseeker">
                ...
                <div class="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title" name="email" type="text" class="input_field" id="email_field" value="${cookie.cuser.value}">
                </div>
                <div class="input_container">
                    ...
                    <input placeholder="Password" title="Inpit title" name="password" value="${cookie.cpass.value}" type="password" class="input_field" id="password_field">
                </div>
                    <b class="notice-erorr">${notice}</b>
                <div style="display: flex;align-items: center; gap:0 15px; margin-left: -63%">
                    <label class="container1">
                        <input  ${cookie.crem != null ?"checked":""} checked="checked" type="checkbox" name="rem"/> 
                ...
                <button title="Sign In" type="submit" class="sign-in_ggl">
                    ...
                    <a href="#!" style="text-decoration: none;font-weight: 600;color:#00000080"><i class="fa-brands fa-google-plus-g"></i> &nbsp; Sign In with Google</a>
                </button>


                <a href="forgetpass.jsp" class="note" style="font-weight: 600;text-decoration: none;">Reset password</a>
                <div style="display: flex;align-items: center">
                    <p class="note" style="color:#00000080;font-weight: 600; ">No account? </p><a style="text-decoration: none;font-weight: 600" href="register.jsp"class="note">Create one</a>
