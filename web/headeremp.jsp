...
<header style="display: flex;
    ...
    <nav class="navbar navbar-expand-lg all-nav">
        ...
        <div class="collapse navbar-collapse box-content" style="display: flex;align-items: center;" id="navbarResponsive">
            ...
            <ul class="example-2" style="display: flex;max-height: 45px;margin-left: 120px;margin-bottom: 0px;">
                <div class="shadow-lg d-none" id="boxNotification" style="position: absolute; background: white; top: 80%;width: 400px;right: 0">
