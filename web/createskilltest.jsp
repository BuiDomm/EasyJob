                            ...
                            <div class="col">
                                ...
                                <div class="row px-3">
                                    <div class="input-group col">
                                        <input type="text" class="form-control" name="questionTitle[]" placeholder="Question title" required="">
                                    </div>
                                    <div class="input-group col">
                                        <div class="col">
                                            <input type="text" class="form-control" name="answer[]" placeholder="Answer" required="">
                                            <input type="text" class="form-control mt-3" name="incorrectanswer[]" placeholder="Incorrect answer" required="">
                            ...
                            <div class="col">
                                ...
                                <div class="row px-3">
                                    <c:forEach var="answer" items="${questionAnswersMap[question]}">
                                        <c:if test="${answer.isTrue eq 1}"> <div style="border-radius: 15px; background-color: #FBC540" class="col-5 p-4 mt-3 mx-4">${answer.answerText} </div> </c:if>
                                        <c:if test="${answer.isTrue eq 0}"><div style="border-radius: 15px" class="col-5 p-4 mt-3 mx-4 bg-dark text-light">${answer.answerText} </div></c:if>
                                    </c:forEach>
                                </div> 
                            </div>
                        </div>
